...
#endif
#include "decon_lcd.h"
#include "../panel_8895/panel_drv.h"
//#include "../panel_8895/panel.h"
...
struct dsim_device {
	...
	struct mipi_panel_drv *mipi_drv;
...
void dsim_reg_wr_tx_header(u32 id, u8 data_id, u8 data0, u8 data1, u32 bta_type);
